...
function FluxUI_Workspace(cfg, callback){
	...
	FluxUI_Workspace.prototype.getDefaultLaunchbar = function(callback){
		var self = this;
		var dBar = false;
		if(self.launchbars.left && self.launchbars.left.isDefault){
			dBar = self.launchbars.left;
		}
		
		if(self.launchbars.right && self.launchbars.right.isDefault){
			dBar = self.launchbars.right;
		}
		
		if(self.launchbars.bottom && self.launchbars.bottom.isDefault){
			dBar = self.launchbars.bottom;
		}
		
		if((self.launchbars.top && self.launchbars.top.isDefault) || (self.launchbars.top && !dBar)){
			dBar = self.launchbars.top;
		}
		if(callback){
			callback(dBar);
		}
